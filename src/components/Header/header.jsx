...
function Nav() {
  ...
  const links = [
    { title: 'Чому', href: '/', src: 'img-1.jpg' },
    { title: 'Проєкт', href: '/shop', src: 'img-2.jpg' },
    { title: 'Потенціал', href: '/about', src: 'img-3.jpg' },
    { title: 'Фонд', href: '/lookbook', src: 'img-4.jpg' },
    { title: 'Інфраструктура', href: '/contact', src: 'img-5.jpg' },
    { title: 'Гарантії', href: '/contact', src: 'img-6.jpg' },
    { title: 'Довіра', href: '/contact', src: 'img-7.jpg' },
    { title: 'Докази', href: '/contact', src: 'img-8.jpg' },
    { title: 'FAQ', href: '/contact', src: 'img-9.jpg' },
  ];
