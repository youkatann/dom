...
const CONTENT = {
  ...
  fireplace: {
    title: 'Fireplace',
    description1: 'Затишне місце, де можна зібратися з друзями за келихом вина, а навкруги — свіже лісове повітря',
    countLabel: 'Місць',
    countValue: 20,
    metrics: [
      { k: '', v: '' },
  ...
  events: {
    ...
    description1: 'Універсальні локації для подій будь-якого формату: від великих весіль з вишуканими церемоніями на терасі до конференцій, масштабних презентацій та корпоративів',
    countLabel: 'Локації',
    countValue: 6,
    metrics: [
