      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-[24px] lg:gap-[40px]">
          ...
          <div className="flex-1">
            <p className="font-medium text-[18px] sm:text-[18px] md:text-[18x] tracking-tighter leading-[1.2] text-foreground text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-[16px] sm:gap-[20px] mt-[20px]">
          {CARDS.map((card, i) => (
            ...
            >
              ...
              {/* Текст */}
              <motion.p
                className="text-white text-[14px] sm:text-[16px] md:text-[18px] lg:text-[18px] font-medium text-center px-[12px] sm:px-[16px] drop-shadow"
                animate={{ opacity: hovered === i ? 0 : 1 }}
