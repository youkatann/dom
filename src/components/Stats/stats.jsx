...
export default function Stats() {
  ...
  return (
    ...
    >
      {/* Заголовок */}
      <h2 className="text-accent text-[36px] sm:text-[48px] md:text-[60px] lg:text-[76px] font-bold tracking-tighter text-center sm:text-left">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-[40px] sm:mt-[60px] gap-[24px] sm:gap-0">
        <p className="text-[16px] sm:text-[18px] md:text-[18px] text-accent-muted max-w-[500px] tracking-tighter leading-[1.3] text-center md:text-left">
